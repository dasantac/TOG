...
PH1_DATA_S_PF_CSV = os.path.join(PH1_DATA_ROOT, f'{DATA_S_PF}.csv')
PH1_DATA_S_PV_CSV = os.path.join(PH1_DATA_ROOT, f'{DATA_S_PV}.csv')
...
PH2_DATA_S_PF_CSV = os.path.join(PH2_DATA_ROOT, f'{DATA_S_PF}.csv')
PH2_DATA_S_PV_CSV = os.path.join(PH2_DATA_ROOT, f'{DATA_S_PV}.csv')
...
tag_columns = ["person_id", "cycle_num", "handedness", "class_name", 
               "class_numeric"]
