...
PH3_DATA_CLEAN_ROOT = os.path.join(PH3_DATA_ROOT, 'clean')
PH3_DATA_RED_ROOT = os.path.join(PH3_DATA_ROOT, 'red')
PH3_DATA_CLEAN_W2_ROOT = os.path.join(PH3_DATA_CLEAN_ROOT, 'w2')
